...
export default function PasaportPage() {
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      const response = await photoService.uploadAndProcessPhoto(uploadedFile, 'pasaport');
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12 p-6 bg-blue-50 rounded-lg border border-blue-200">
            <h2 className="text-xl font-semibold text-blue-900 mb-4 flex items-center">
              ...
              Pasaport Fotoğrafı Standartları
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold text-blue-800 mb-2">Teknik Özellikler</h3>
                <ul className="space-y-1 text-blue-700">
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-blue-600" />Boyut: 50x60 mm (413x531 piksel)</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-blue-600" />Açık gri arka plan</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-blue-600" />Yüz oranı: %70-80</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-blue-600" />Çözünürlük: 300 DPI</li>
                </ul>
              </div>
              <div>
                <h3 className="font-semibold text-blue-800 mb-2">Gereksinimler</h3>
                <ul className="space-y-1 text-blue-700">
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-blue-600" />Doğrudan kameraya bakış</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-blue-600" />Nötr yüz ifadesi</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-blue-600" />6 ay geçerlilik</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-blue-600" />ICAO 9303 uyumlu</li>
                </ul>
              </div>
            </div>
          </div>
                    ...
                    <button
                      ...
                      className={`inline-flex items-center justify-center px-8 py-4 border border-transparent text-lg font-medium rounded-lg shadow-sm text-white ${
                        isProcessing
                          ...
                          : 'bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transform hover:scale-105 transition-all duration-200'
                      }`}
                    >
                      {isProcessing ? (
                        <>
            ...
            {processedUrl && (
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 mb-2">Pasaport Fotoğrafı</h4>
                    <img
                      src={processedUrl}
                      alt="İşlenmiş pasaport fotoğrafı"
                      className="w-full rounded-lg shadow-sm"
                    />
                    <button
          ...
          {/* Pasaport Fotoğrafı Hakkında */}
          <div className="bg-white p-8 rounded-lg shadow-sm border mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 mb-6">Pasaport Fotoğrafı Hakkında</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">ICAO Standartları</h3>
                <p className="text-gray-600 mb-4">
                  Pasaport fotoğrafları, Uluslararası Sivil Havacılık Örgütü (ICAO) tarafından belirlenen 
                  9303 standardına uygun olmalıdır. Bu standart, dünya çapında kabul edilen biyometrik 
                  fotoğraf gereksinimlerini belirler.
                </p>
                <ul className="space-y-2 text-gray-600">
                  <li>• Yüz, fotoğrafın %70-80'ini kapsamalı</li>
                  <li>• Gözler, fotoğrafın merkezinden 7-8mm yukarıda</li>
                  <li>• Başın üstünde 3-5mm boşluk</li>
                  <li>• Çenenin altında 5-7mm boşluk</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  ICAO standartlarına uygun pasaport fotoğrafları aşağıdaki belgeler için kullanılabilir:
                </p>
                <ul className="space-y-2 text-gray-600">
