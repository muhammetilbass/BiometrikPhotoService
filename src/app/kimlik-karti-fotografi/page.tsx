...
export default function KimlikKartiPage() {
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      const response = await photoService.uploadAndProcessPhoto(uploadedFile, 'kimlik');
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="w-20 h-20 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-6">
              <div className="w-12 h-14 bg-red-600 rounded-sm flex items-center justify-center">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Biometrik kimlik kartı standartlarına uygun fotoğraf oluşturun
            </p>
          </div>
          ...
          <div className="mb-12 p-6 bg-red-50 rounded-lg border border-red-200">
            <h2 className="text-xl font-semibold text-red-900 mb-4 flex items-center">
              ...
              Kimlik Kartı Fotoğrafı Standartları
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold text-red-800 mb-2">Teknik Özellikler</h3>
                <ul className="space-y-1 text-red-700">
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-red-600" />Boyut: 50x60 mm (413x531 piksel)</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-red-600" />Beyaz arka plan</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-red-600" />Yüz oranı: %70-80</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-red-600" />Çözünürlük: 300 DPI</li>
                </ul>
              </div>
              <div>
                <h3 className="font-semibold text-red-800 mb-2">Gereksinimler</h3>
                <ul className="space-y-1 text-red-700">
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-red-600" />Doğrudan kameraya bakış</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-red-600" />Biometrik uyumluluk</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-red-600" />15+ yaş için geçerli</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-red-600" />Nüfus Müdürlüğü onaylı</li>
                </ul>
              </div>
            </div>
          </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-sm border">
                <div className="text-center mb-6">
                  <div className="flex items-center justify-center mb-4">
                    ...
                    <PhotoIcon className="h-10 w-10 text-red-600" />
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  >
                    <input {...getInputProps()} />
                    <button className="w-full px-6 py-3 bg-red-600 text-white rounded-lg font-medium hover:bg-red-700 transition-colors">
                      Fotoğraf yükle
                    </button>
                  </div>
                    ...
                    <button
                      ...
                      className={`inline-flex items-center justify-center px-8 py-4 border border-transparent text-lg font-medium rounded-lg shadow-sm text-white ${
                        isProcessing
                          ...
                          : 'bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transform hover:scale-105 transition-all duration-200'
                      }`}
                    >
                      {isProcessing ? (
                        <>
                        ...
                        <>
                          ...
                          Kimlik Kartı Fotoğrafı Oluştur
                        </>
                      )}
                    </button>
            ...
            {processedUrl && (
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 mb-2">Kimlik Kartı Fotoğrafı</h4>
                    <img
                      src={processedUrl}
                      alt="İşlenmiş kimlik kartı fotoğrafı"
                      className="w-full rounded-lg shadow-sm"
                    />
                    <button
          ...
          {/* Kimlik Kartı Fotoğrafı Hakkında */}
          <div className="bg-white p-8 rounded-lg shadow-sm border mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 mb-6">Kimlik Kartı Fotoğrafı Hakkında</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Biometrik Standartlar</h3>
                <p className="text-gray-600 mb-4">
                  Kimlik kartı fotoğrafları, İçişleri Bakanlığı Nüfus ve Vatandaşlık İşleri 
                  Genel Müdürlüğü tarafından belirlenen biometrik standartlara uygun olmalıdır. 
                  Bu standartlar, güvenli kimlik doğrulama için gereklidir.
                </p>
                <ul className="space-y-2 text-gray-600">
                  <li>• Yüz, fotoğrafın %70-80'ini kapsamalı</li>
                  <li>• Beyaz arka plan zorunlu</li>
                  <li>• Biometrik çip ile uyumlu</li>
                  <li>• 15 yaş ve üzeri için geçerli</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  Biometrik standartlara uygun kimlik kartı fotoğrafları aşağıdaki işlemler için kullanılabilir:
                </p>
                <ul className="space-y-2 text-gray-600">
                  <li>• T.C. Kimlik Kartı Başvurusu</li>
                  <li>• Kimlik Kartı Yenileme</li>
                  <li>• Adres Değişikliği</li>
                  <li>• Kayıp/Çalıntı Kimlik Kartı</li>
                  <li>• Nüfus Cüzdanı İşlemleri</li>
                </ul>
              </div>
            </div>
          </div>
