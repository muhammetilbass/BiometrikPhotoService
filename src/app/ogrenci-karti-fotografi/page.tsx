...
export default function OgrenciKartiPage() {
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      const response = await photoService.uploadAndProcessPhoto(uploadedFile, 'ogrenci-karti');
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="w-20 h-20 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-6">
              <div className="w-12 h-14 bg-orange-600 rounded-sm flex items-center justify-center">
                <div className="w-8 h-8 bg-white rounded-full"></div>
              </div>
            </div>
            <h1 className="text-4xl font-bold text-gray-900 mb-4">
              Öğrenci Kartı Fotoğrafı
            </h1>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Üniversite ve okul öğrenci kartları için uygun fotoğraf
            </p>
          </div>

          {/* Standartlar */}
          <div className="mb-12 p-6 bg-orange-50 rounded-lg border border-orange-200">
            <h2 className="text-xl font-semibold text-orange-900 mb-4 flex items-center">
              <InformationCircleIcon className="h-6 w-6 mr-2" />
              Öğrenci Kartı Fotoğrafı Standartları
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold text-orange-800 mb-2">Teknik Özellikler</h3>
                <ul className="space-y-1 text-orange-700">
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-orange-600" />Boyut: 35x45 mm (295x378 piksel)</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-orange-600" />Açık mavi veya beyaz arka plan</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-orange-600" />Yüz oranı: %70-80</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-orange-600" />Çözünürlük: 300 DPI</li>
                </ul>
              </div>
              <div>
                <h3 className="font-semibold text-orange-800 mb-2">Gereksinimler</h3>
                <ul className="space-y-1 text-orange-700">
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-orange-600" />Doğrudan kameraya bakış</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-orange-600" />Net ve kaliteli</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-orange-600" />Güncel fotoğraf</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-orange-600" />Okul standartlarına uygun</li>
                </ul>
              </div>
            </div>
          </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-sm border">
                <div className="text-center mb-6">
                  <div className="flex items-center justify-center mb-4">
                    ...
                    <PhotoIcon className="h-10 w-10 text-orange-600" />
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  >
                    <input {...getInputProps()} />
                    <button className="w-full px-6 py-3 bg-orange-600 text-white rounded-lg font-medium hover:bg-orange-700 transition-colors">
                      Fotoğraf yükle
                    </button>
                  </div>
                    ...
                    <button
                      ...
                      className={`inline-flex items-center justify-center px-8 py-4 border border-transparent text-lg font-medium rounded-lg shadow-sm text-white ${
                        isProcessing
                          ...
                          : 'bg-orange-600 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transform hover:scale-105 transition-all duration-200'
                      }`}
                    >
                      {isProcessing ? (
                        <>
                        ...
                        <>
                          ...
                          Öğrenci Kartı Fotoğrafı Oluştur
                        </>
                      )}
                    </button>
            ...
            {processedUrl && (
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 mb-2">Öğrenci Kartı Fotoğrafı</h4>
                    <img
                      src={processedUrl}
                      alt="İşlenmiş öğrenci kartı fotoğrafı"
                      className="w-full rounded-lg shadow-sm"
                    />
                    <button
          ...
          {/* Öğrenci Kartı Fotoğrafı Hakkında */}
          <div className="bg-white p-8 rounded-lg shadow-sm border mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 mb-6">Öğrenci Kartı Fotoğrafı Hakkında</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Genel Standartlar</h3>
                <p className="text-gray-600 mb-4">
                  Öğrenci kartı fotoğrafları, eğitim kurumlarının belirlediği standartlara uygun olmalıdır. 
                  Genellikle kimlik belgesi standartlarına benzer kurallar geçerlidir ancak daha esnek 
                  olabilir.
                </p>
                <ul className="space-y-2 text-gray-600">
                  <li>• Boyut: 35x45 mm (standart kimlik fotoğrafı)</li>
                  <li>• Açık mavi, gri veya beyaz arka plan</li>
                  <li>• Net ve kaliteli görüntü</li>
                  <li>• Güncel fotoğraf (son 6 ay)</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  Öğrenci kartı fotoğrafları aşağıdaki durumlarda kullanılabilir:
                </p>
                <ul className="space-y-2 text-gray-600">
                  <li>• Üniversite öğrenci kartları</li>
                  <li>• Lise öğrenci kartları</li>
                  <li>• Dil kursu kartları</li>
                  <li>• Kütüphane üyelik kartları</li>
                  <li>• Öğrenci indirim kartları</li>
                  <li>• Kampüs erişim kartları</li>
                </ul>
              </div>
            </div>
          </div>
