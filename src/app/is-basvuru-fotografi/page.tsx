...
export default function IsBasvuruPage() {
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      const response = await photoService.uploadAndProcessPhoto(uploadedFile, 'is-basvurusu');
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="w-20 h-20 bg-indigo-100 rounded-full flex items-center justify-center mx-auto mb-6">
              <div className="w-12 h-14 bg-indigo-600 rounded-sm flex items-center justify-center">
                <div className="w-8 h-8 bg-white rounded-full"></div>
              </div>
            </div>
            <h1 className="text-4xl font-bold text-gray-900 mb-4">
              İş Başvuru Fotoğrafı
            </h1>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              CV ve iş başvuruları için profesyonel fotoğraf
            </p>
          </div>

          {/* Standartlar */}
          <div className="mb-12 p-6 bg-indigo-50 rounded-lg border border-indigo-200">
            <h2 className="text-xl font-semibold text-indigo-900 mb-4 flex items-center">
              <InformationCircleIcon className="h-6 w-6 mr-2" />
              İş Başvuru Fotoğrafı Standartları
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold text-indigo-800 mb-2">Teknik Özellikler</h3>
                <ul className="space-y-1 text-indigo-700">
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-indigo-600" />Boyut: 35x45 mm (295x378 piksel)</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-indigo-600" />Açık gri veya beyaz arka plan</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-indigo-600" />Yüz oranı: %70-80</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-indigo-600" />Çözünürlük: 300 DPI</li>
                </ul>
              </div>
              <div>
                <h3 className="font-semibold text-indigo-800 mb-2">Gereksinimler</h3>
                <ul className="space-y-1 text-indigo-700">
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-indigo-600" />Profesyonel görünüm</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-indigo-600" />Doğrudan kameraya bakış</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-indigo-600" />Güncel fotoğraf</li>
                  <li className="flex items-center"><CheckCircleIcon className="h-4 w-4 mr-2 text-indigo-600" />İş kıyafeti tercih edilir</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            {processedUrl && (
              <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 mb-2">İş Başvuru Fotoğrafı</h4>
                    <img
                      src={processedUrl}
                      alt="İşlenmiş iş başvuru fotoğrafı"
                      className="w-full rounded-lg shadow-sm"
                    />
                    <button
          ...
          {/* İş Başvuru Fotoğrafı Hakkında */}
          <div className="bg-white p-8 rounded-lg shadow-sm border mb-12">
            <h2 className="text-2xl font-semibold text-gray-900 mb-6">İş Başvuru Fotoğrafı Hakkında</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Profesyonel Standartlar</h3>
                <p className="text-gray-600 mb-4">
                  İş başvuru fotoğrafları, profesyonel bir görünüm sergilemeli ve işverenler 
                  üzerinde olumlu bir izlenim bırakmalıdır. CV'nizde kullanacağınız fotoğraf, 
                  kariyerinizde önemli bir rol oynayabilir.
                </p>
                <ul className="space-y-2 text-gray-600">
                  <li>• Boyut: 35x45 mm (standart kimlik fotoğrafı)</li>
                  <li>• Açık gri veya beyaz arka plan</li>
                  <li>• Profesyonel kıyafet</li>
                  <li>• Güvenilir ve samimi ifade</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  Profesyonel fotoğraflarınızı aşağıdaki durumlarda kullanabilirsiniz:
                </p>
                <ul className="space-y-2 text-gray-600">
                  <li>• CV ve özgeçmiş</li>
                  <li>• LinkedIn profili</li>
                  <li>• İş başvuru formları</li>
                  <li>• Şirket profil sayfaları</li>
                  <li>• Profesyonel portfolyo</li>
                  <li>• İş ağı platformları</li>
                </ul>
              </div>
            </div>
          </div>
